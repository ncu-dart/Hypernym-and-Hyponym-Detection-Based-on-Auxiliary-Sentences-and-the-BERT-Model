...
parser.add_argument("-dataset", help="path to training set", dest="dataset", default = '../../data/train/test_train.txt')
...
parser.add_argument("-model", help="model name", dest="model_name", default='../../output/task1_BERT_')
...
class HeirachicalDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        if random.randint(0, 1) == 0:
            ...
            word_pieces += (tokens_b + tokens_a + ["[SEP]"])
...
class NegativeDataset(Dataset):
    ...
    def __init__(self, tokenizer):
        self.df  = pd.read_csv(args.dataset, sep="\t", header=None)
#         self.df  = pd.read_csv('lexical_wordnet.txt', sep="\t", header=None)
...
trainset_normal = HeirachicalDataset(tokenizer=tokenizer)
...
trainloader = DataLoader(trainset, batch_size=args.b, num_workers = 10,

...
#         print('f1 ', f1)
    ...
    else:                 #沒有 val set 抽0.02 testset 當 val set
        #find f1 threshold
        ...
        for i in range(len(precisions)):
            divisor = precisions[i]+recalls[i]
            #devide by zero
            if divisor == 0:
                temp_f1 = 0.0
            else:
                temp_f1 = 2*precisions[i]*recalls[i] / (divisor)
            if(temp_f1 > f1_res[3]):
...
minus_num = 20
print('Shwartz random', '-'*minus_num)
